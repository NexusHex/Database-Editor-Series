...
Notes
............. Now all those annoying file issues will totally unfaze the app's operation! You also now have much more freedom while deleting items from the database in session. Enjoy!
    """
    print(current_patch)
